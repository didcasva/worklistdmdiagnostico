...
class PacientesController extends Controller
{
    ...
    public function update(Request $request, $N_Orden)
        ...
        'CCDespesor' => 'required|integer|min:1|max:1000',
        'MLDespesor' => 'required|integer|min:1|max:1000',
        'CCIespesor' => 'required|integer|min:1|max:1000',
        'MLIespesor' => 'required|integer|min:1|max:1000',
